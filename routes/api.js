...
var creatorList = ['@W4FXploit','@alpha'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6281386383559 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6281386383559 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------W4FXploitGanteng'+'W4FXploit--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'w4fxploitbot') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/randomquotes`))
...
router.get('/hadits', async (req, res, next) => {
    ...
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter nomor"})
       ...
       fetch(encodeURI(`https://hadits-api-w4fxploit.vercel.app/books/${kitab}/${nomor}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fbdown', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://fb-api-w4fxploit.vercel.app/?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/tahlil', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/wirid', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/ayatkursi', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/doaharian', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/bacaanshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataNiatShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/kisahnabi', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataKisahNabi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/dataAsmaulHusna.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshubuh', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatdzuhur', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatmaghrib', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatisya', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatashar', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/CyberSpace.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/Technology.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/Islamic.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/Programming.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/pegunungan', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/My-SQL-Results/main/Mountain.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jadwalshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/w4fxploit/w4fxploit-Database/main/adzan/${kota}/2021/03.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fakedata', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://fakename-api-w4fxploit.vercel.app/api/fakename?country=${country}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilih', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://hilih-api-w4fxploit.vercel.app/api/hilih?kata=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/liriklagu', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/lirik?search=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/chordlagu', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/chord?q=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/random/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kbbi', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://kbbi-api-w4fxploit.vercel.app/api/kbbi?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidindo', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-w4fxploit.vercel.app/api/covid-indonesia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidworld', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-w4fxploit.vercel.app/api/world`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kodepos', async (req, res, next) => {
	...
	if(!kota) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kota"})
       ...
       fetch(encodeURI(`https://kodepos-api-w4fxploit.vercel.app/?q=${kota}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnn', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-w4fxploit.vercel.app/v1/cnn-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnbc', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-w4fxploit.vercel.app/v1/cnbc-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/republika', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-w4fxploit.vercel.app/v1/republika-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/tempo', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-w4fxploit.vercel.app/v1/tempo-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/antara', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-w4fxploit.vercel.app/v1/antara-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/kumparan', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://news-api-w4fxploit.vercel.app/v1/kumparan-news`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/search', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://filmapik-api-w4fxploit.herokuapp.com/search?q=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/kategori', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://filmapik-api-w4fxploit.herokuapp.com/category?search=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/play', async (req, res, next) => {
    ...
    if (!id) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter id"})
       ...
       fetch(encodeURI(`https://filmapik-api-w4fxploit.herokuapp.com/play?id=${id}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/terbaru', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://filmapik-api-w4fxploit.herokuapp.com/latest`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/search', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/search?query=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/terbaru', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/newupload`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/comingsoon', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/comingsoon`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/tvseries', async (req, res, next) => {
	...
	if(apikeyInput != 'w4fxploitbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/tv`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/year', async (req, res, next) => {
    ...
    if (!tahun) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter tahun"})
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/year?year=${tahun}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/country', async (req, res, next) => {
    ...
    if (!negara) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter negara"})
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/country?country=${negara}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/genre', async (req, res, next) => {
    ...
    if (!tipe) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter tipe"})
       ...
       fetch(encodeURI(`https://lk21-api-w4fxploit.herokuapp.com/genre?genre=${tipe}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/video', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/ytv?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/audio', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/yta?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/ig/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://python-api-w4fxploit.herokuapp.com/api/stalk?username=${username}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/textmaker?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker2', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/textmaker2?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/textmaker3?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker4', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/textmaker4?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/text3d?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no2', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/text3d-2?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no3', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/text3d-3?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no4', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/text3d-4?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker/special/transformer', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/special/transformer?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker/special/epep', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-w4fxploit.herokuapp.com/api/special/sertifikatepep?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
